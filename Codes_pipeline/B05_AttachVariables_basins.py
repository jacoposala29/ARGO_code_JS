...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 22 20:04:23 2020
...
from TC_and_TS_define_param import (Basins,year_pairs,year_start_TC,folder2use)
...
for bs, fi in Basins: 
    HU = pkl.load(open('./Outputs/' +str(bs) + '_PairDF.pkl', 'rb'))
    ...
    pkl.dump(HU, open(str(folder2use) + '/Outputs/HurricaneAdjRawVariableDF_' +str(bs) + '.pkl', 'wb'))
